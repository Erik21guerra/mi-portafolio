...
export const Contact = () => {
    ...
    const {buttonText, setButtonText} = useState("Enviado");
              ...
              <form onSubmit={handleSubmit}>
               <Row>
                <Col sm={6} className="px-1">
                    <input type="text" value={formDetails.fristName} placeholder="Nombre" onChange={(e)=> onFormUpdate("fristName", e.target.value)}></input>
                </Col>
                <Col sm={6} className="px-1">
                ...
                <Col sm={6} className="px-1">
                <input type="tel" value={formDetails.phone} placeholder="Numero de Telefono" onChange={(e)=> onFormUpdate("phone", e.target.value)}></input>
                </Col>
                <Col>
